...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <header class="app-header"><a class="app-header__logo" href="viewbooks.php">Library management</a>
      ...
      <ul class="app-nav">
        <li class="app-search">
          <input id="myInput" onkeyup="myFunction()" class="app-search__input" type="search" placeholder="Search by book Title">
		...
		<p style="text-align:center;font-size:20px;margin-top:50px;color:black">welcome librarian to the system </p>  
			    ...
			    <div class="sarah" style="float:right">	  
					...
					<div class="search">
						...
						<caption id="you" style="text-align:center padding:5px" >ALL BOOKS ARE REGISTERED HERE</caption>
						<tr>
							<th>Book ISBN</th>
							<th>Book Title</th>
							<th>Book Author</th>
						...
						<tr>
							...
							<td><a href="bookslb.php?B_Code=<?php echo $row['B_Code']; ?>"><i class="glyphicon glyphicon-edit"></i></a></td>
						</tr>
						<?php
						}
						?>	
