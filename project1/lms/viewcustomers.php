...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <header class="app-header"><a class="app-header__logo" href="index.html">Library management</a>
      ...
      <ul class="app-nav">
        <li class="app-search">
          <input class="app-search__input" id="myInput" onkeyup="myFunction()"type="search" placeholder="Search by first name">
		...
		<p style="text-align:center;font-size:20px;margin-top:50px;color:black">welcome librarian to the system </p>  
					...
					<table class="table table-bordered table-hover" id="myTable">
						...
						<tr>
							...
							<td><a href="updatecustomer.php?U_ID=<?php echo $row['U_ID']; ?>"><i class="glyphicon glyphicon-edit"></i></a></td>
						</tr>
						<?php
						}
						?>
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    td = tr[i].getElementsByTagName("td")[1];//pakubadili number,0,1,2
    if (td) {
